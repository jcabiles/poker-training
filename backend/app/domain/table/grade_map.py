...
existing strategy content (preflop RFI / vs-RFI / blind defense / vs-3-bet /
vs-4-bet / vs-limpers; HU flop c-bet) and returns None for anything it cannot
build with full confidence (multiway, off-size, off-pack, cold-call and
limp-raise lines, 5-bet+ pots, turn/river). None ⇒
